...
/**
 * mybatisplus3代码生成器 去掉了service接口层
 *
 * @author liangc
 */
public class HeXiaoZhuCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String version = "1.0";
        // 项目名称
        String projectName = "hexiaozhu-admin";
        // 定义url路径前缀
        String rootUrlMappering = "hexiaozhu";
        // 模板名称
        String moduleName = "admin";
        // 根包名
        String basePackage = "com.chinamobile.zj." + rootUrlMappering;
        // 开发人员
        String author = "linqingsen";

        //是否生成feign client代码
        boolean enableFeignClient = true;
        // 设置程序代码输出根目录
//    String outputRootDir = "/Users/liangchao/tmp/";
        String outputRootDir = "/Users/gurengui/IdeaProjects/xingShu/wechatrobot-service/";
        // 设置代码输出目录
...
//        String templateDir = "lc-custom";
        String templateDir = "onlygetpost";
...
//    String[] tables = new String[] {};
        ...
        gc.setEnableFeignClient(enableFeignClient);
        gc.setFeignClientEndpoint(String.format("${%s.%s-service-endpoint}", rootUrlMappering, moduleName));
